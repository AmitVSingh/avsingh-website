...
sections:
  - block: resume-biography-3
    content:
      ...
      button:
        text: Download CV
        url: /uploads/resume_amitvsingh.pdf
    design:
      css_class: dark
      background:
        color: black
  ...
  - block: markdown
    content:
      ...
      subtitle: ''
      text: |-
        I worked at a high-tech company to implement solutions that are not only high-performing today but resilient and sustainable for the future. My work spans across digital transformation, smart manufacturing, and intelligent automation, with an emphasis on system architecture, operational scalability, and technology alignment.
